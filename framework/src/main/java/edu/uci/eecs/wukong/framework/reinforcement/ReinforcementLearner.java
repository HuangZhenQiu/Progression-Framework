...
import edu.uci.eecs.wukong.framework.reinforcement.ReinforcementPolicy;
import edu.uci.eecs.wukong.framework.reinforcement.ReinforcementWorld;
...
public class ReinforcementLearner {
	...
	private ReinforcementWorld thisWorld;
	private ReinforcementPolicy policy;

	protected int learningMethod;
	protected int actionSelection;

	protected double epsilon, temp, alpha, gamma, lambda;
	protected int[] dimSize, state, newstate;
	protected int action, epochs;
	...
	public ReinforcementLearner(ReinforcementWorld world) {
		...
		policy = new ReinforcementPolicy(dimSize);
	...
	public ReinforcementPolicy getPolicy() {
	...
	public ReinforcementPolicy newPolicy() {
		policy = new ReinforcementPolicy(dimSize);
		// Initializing the policy with the initial values defined by the world.
		policy.initValues(thisWorld.getInitValues());
		return policy;
