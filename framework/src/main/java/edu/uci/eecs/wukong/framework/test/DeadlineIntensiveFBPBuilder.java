...
public class DeadlineIntensiveFBPBuilder extends MockFBPBuilder {
	...
	private static final long PROGRESSION_SERVER_LONG_ADDRESS = 2;
	...
	private static final short MOCK_MOBILE_INPUT_WUCLASS_ID = 20000;
	private static final byte MOCK_MOBILE_INPUT_PORT = 1;
	
	// The fake wuobject that will receive result form localication prclass;
	private static final short MOCK_MOBILE_OUTPUT_WUCLASS_ID = 20001;
	...
	protected void createComponentMap() {
		...
		this.reprogrammer.addPrObject(MOCK_MOBILE_INPUT_WUCLASS_ID, MockGateway.MOCK_GATEWAY_ADDRESS, MOCK_MOBILE_INPUT_PORT);
		...
		this.reprogrammer.addPrObject(MOCK_MOBILE_OUTPUT_WUCLASS_ID, MockGateway.MOCK_GATEWAY_ADDRESS, MOCK_MOBILE_OUTPUT_PORT);
	}
