...
public class ActivityExecutionExtension extends AbstractExecutionExtension<ActivityRecgonitionEdgeClass>
	...
	public ActivityExecutionExtension(ActivityRecgonitionEdgeClass plugin) {
		super(plugin);
		try {
