...
@WuClass(id = 9001)
public class ICSDemoBloomEdgeClass extends EdgePrClass {
	...
	public ICSDemoBloomEdgeClass(PrClassMetrics metrics) {
		super("ICSDemoBloomPrClass", metrics);
		hueObj = new ICSDemoHueEdgeClass("ICSDemoBloomPrClass", "LCT001");
